...
# 3s of silence needed before treating speech as over - room to breathe/pause
# mid-sentence without getting cut off. Trades some response latency for that.
SILENCE_END_BLOCKS = 30
